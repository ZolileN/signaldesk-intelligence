                    ...
                    {selectedNetworkNode && (
                      <div style={{ position: 'absolute', top: '16px', right: '16px', width: '220px', padding: '12px', borderRadius: '6px', border: '1px solid var(--border-color)', background: 'rgba(10,14,23,0.95)', fontSize: '0.8rem', color: '#fff', zIndex: 10 }}>
                        ...
                        <div style={{ color: 'var(--text-muted)', marginBottom: '4px' }}>
                          Role: {selectedNetworkNode === 'Community Nets' ? 'Primary Actor' : selectedNetworkNode === 'Political Party' ? 'Amplifier' : selectedNetworkNode === 'Affected Business' ? 'Affected Party' : 'Responder'}
                        </div>
                        <div style={{ color: 'var(--text-dim)', fontSize: '0.75rem' }}>Click node for details</div>
                      </div>
                    )}
                  </div>
                </div>
